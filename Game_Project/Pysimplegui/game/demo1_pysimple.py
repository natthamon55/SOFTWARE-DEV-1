...
def game():
    ...
    layout = [
            [sg.Text('TIME : ', size=(10, 1), font=('Segoe UI', 20), text_color='White'),sg.Text('--------', size=(1, 1), font=('Segoe UI', 14), text_color='Black'),sg.Text('', size=(10, 1), font=('Helvetica', 22),text_color = 'White',key='timer'),
            sg.Button('Ball', size=(10, 1), font='Helvetica 14'),
            sg.Button('Exit', size=(10, 1), font='Helvetica 14') ],
            [sg.Text('SCORE : ', size=(15, 1), font=('Segoe UI', 20), text_color='White'),sg.Text('', size=(15, 1), font=('Segoe UI', 20), text_color='White', key='score')] ,
