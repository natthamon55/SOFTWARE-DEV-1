...
layout = [
            ...
            [sg.ReadFormButton('DateTime',button_color=(Black,Yellow)), sg.Text('Time : ', size=(5, 1), font=('Segoe UI', 14),text_color='Blue'), sg.Text('', size=(10, 1), font=('Segoe UI', 18), text_color='Black', key='time')]
...
while running:
    ...
    if button == 'CE': # clear all element 
        ...
        form.FindElement('time').Update(now)
