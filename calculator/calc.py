...
layout = [
            ...
            [sg.ReadFormButton('.',button_color=(Black,DarkGreen)),sg.ReadFormButton('0',button_color=(Black,LightGreen)), sg.ReadFormButton('=',button_color=(Black,DarkGreen)), sg.ReadFormButton('+',button_color=(Black,DarkGreen))],
        ]
